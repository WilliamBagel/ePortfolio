...
import { CSS3DIntegratedRenderer } from "./CSS3DIntegratedRenderer.js";
import * as TWEEN from "tween";

class World {
  constructor() {
    this.renderer = new CSS3DIntegratedRenderer();
    ...
    element.onclick = (e)=> {for(let handler of this._clickHandlers)handler(e)}
  ...
  requestPointerLock(element){
    ...
    if(element.mozRequestPointerLock)element.mozRequestPointerLock();
  }
  onMouseInput(type, e, itype, element) {
    ...
    //update highlighted and selected element
  }
  _animate(t) {
